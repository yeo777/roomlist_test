...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRoomList.add(Room(80000000,"마포구 서교동",1,"\uD83D\uDE0A 망원/홍대역 풀옵션 넓은 원룸"))
        mRoomList.add(Room(285000000,"마포구 서교동",3,"신혼부부의 보금자리 서교동 신축"))
        mRoomList.add(Room(120000000,"마포구 서교동",5,"★홍대입구역 인근 원룸 전세★"))
        mRoomList.add(Room(120000000,"마포구 성산동",3,"♥♥강추!! 보세요!! 넓고 반듯한 원룸"))
        mRoomList.add(Room(120000000,"마포구 망원1동",3,"※풀옵션 원룸 전세※"))
        mRoomList.add(Room(150000000,"마포구 망원동",2,"초역세권★ 베란다 공간 있는 원룸"))
